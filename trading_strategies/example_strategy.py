...
def example_strategy(self, orderbook1, orderbook2):
    ...
    if bid1/ask2 > 1.0025:
        ...
        db_helper.log_trade(self.ticker, 'Buy on KuCoin', 'Sell on MEXC', ask2, bid1, bid1/ask2, 0)
    elif bid2/ask1 > 1.0025:
        print(f"Ratio between bid2 and ask1: {bid2/ask1}")
        db_helper.log_trade(self.ticker, 'Buy on MEXC', 'Sell on KuCoin', ask1, bid2, bid2/ask1, 0)
    else:
